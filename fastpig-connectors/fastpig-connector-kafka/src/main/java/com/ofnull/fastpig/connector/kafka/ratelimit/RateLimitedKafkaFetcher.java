 ...
 */
@Internal
public class RateLimitedKafkaFetcher<T> extends AbstractFetcher<T, TopicPartition> {
     ...
     */
//    final RateLimitedKafkaConsumerThread consumerThread;
    final RaliKafkaConsumerThread consumerThread;
    ...
    public RateLimitedKafkaFetcher(
        ...
        this.consumerThread =
//                new RateLimitedKafkaConsumerThread<T>(
                new RaliKafkaConsumerThread<T>(
                        LOG,
                        handover,
                        kafkaProperties,
        ...
        consumerMetricGroup.gauge("rateLimited", (Gauge<Long>) () -> rateLimiter.getTotalRateLimit());
        consumerMetricGroup.gauge("partitionRateLimited", (Gauge<Long>) () -> rateLimiter.getPartitionRateLimit());
        consumerMetricGroup.gauge("rateUsed", (Gauge<Long>) () -> rateLimiter.getPartitionRateLimit());
    }
